          ...
          <div class="row"> 
            ...
            <div id="container" class="large-8 columns grey1">
              <table> 
               <thead> 
                 <tr> 
                   <th width="300">Texto Pregunta</th> 
...
<div id="rowTemplate" style="">

  <tr id='id'> 
    <td> $text </td>
    <td> <a onclick="addQuestion();" class='tiny button secondary'>Agregar</a> </td> 
  </tr>
</div>
...
<script>
  ...
  function filterQuestions(){
    ...
    var template =  "<tr id='id'> <td> $text </td><td> <a onclick='addQuestion();' class='tiny button secondary'>Agregar</a> </td> </tr>";
